...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "relative inline-flex items-center justify-center rounded-lg bg-muted text-muted-foreground overflow-hidden",
      className
    )}
    {...props}
  />
